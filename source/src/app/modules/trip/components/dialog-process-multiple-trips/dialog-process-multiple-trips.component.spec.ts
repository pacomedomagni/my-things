...
import { of } from "rxjs";
import { DialogProcessMultipleTripsComponent } from "./dialog-process-multiple-trips.component";
...
function setup() {
	...
	const builder = {
		...
		build() {
			return new DialogProcessMultipleTripsComponent(injectedData, data, tripService);
		}
	};
	return builder;
}
